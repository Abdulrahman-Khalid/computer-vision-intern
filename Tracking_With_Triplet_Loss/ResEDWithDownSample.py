...
class ResEDWithDownSample(nn.Module):
    def __init__(
        self,
        in_channels=3,
        n_classes=3,
        ...
        """
        super(ResEDWithDownSample, self).__init__()
        ...
        for i in reversed(range(1, depth - 1)): # changed part
    ...
    def init_weights(m, fill_W=1, fill_b=0):
        m.weight.data.fill_(fill_W)
        m.bias.data.fill_(fill_b)
